    ...
    <div className="p-6 bg-slate-50 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-2 px-4 py-2 border border-slate-300 rounded-lg bg-white hover:bg-slate-50 text-sm font-medium">
            <Download className="h-4 w-4" />
            Export CSV
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm font-medium">
          ...
          <div>
            ...
            <span
              className={`inline-block mt-1 px-2 py-0.5 text-xs font-medium rounded ${
                RISK_LEVEL_COLORS[clientDetail.riskLevel] ?? "bg-slate-100"
              }`}
            >

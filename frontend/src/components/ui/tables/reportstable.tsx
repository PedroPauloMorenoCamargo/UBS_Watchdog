    ...
    >
      <Table className="w-full">
        <TableHeader className="sticky top-0 z-10 bg-white">
          <TableRow>
            <TableHead className="w-[20%] px-4 py-3">Client ID</TableHead>
            <TableHead className="w-[20%] px-4 py-3">Client Name</TableHead>
            <TableHead className="w-[20%] px-4 py-3">Alerts</TableHead>
            <TableHead className="w-[20%] px-4 py-3">Balance (USD)</TableHead>
            <TableHead className="w-[20%] px-4 py-3 text-center">Risk Level</TableHead>
          </TableRow>
        </TableHeader>
